...
namespace Xsolla.Core
{
	internal class UrlBuilder
	{
		...
		public UrlBuilder AddProjectIdUnderscore(string value)
		{
		...
		public UrlBuilder AddPayload(string value)
		{
			return AddParam("payload", value);
		}
		
		public UrlBuilder AddWithLogout(string value)
		{
			return AddParam("with_logout", value);
		}
		...
		public UrlBuilder AddPurchaseSku(string value)
		{
			return AddParam("purchase-sku", value);
		}
		
		public UrlBuilder AddUserId(string value)
		{
			return AddParam("user-id", value);
		}
		
		public UrlBuilder AddRedirectUrl(string value)
		{
			return AddParam("redirect-url", value);
		}
		
		public UrlBuilder AddWebshopContent(string value)
		{
			return AddParam("utm_content", value);
		}
